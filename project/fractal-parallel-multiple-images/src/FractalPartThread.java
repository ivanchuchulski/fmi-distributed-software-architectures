...
public class FractalPartThread implements Callable<BufferedImage> {
	final private int index;
	private final int startingRow;
	private final int numberOfRows;

	public FractalPartThread(int index, int startingRow, int numberOfRows) {
		this.index = index;
	...
	public BufferedImage call() {
		...
		BufferedImage bufferedImage = new BufferedImage(Main.width, Main.height, BufferedImage.TYPE_3BYTE_BGR);
...
//				printInfoAboutPoint(xPixel, yPixel, realValue, imaginaryValue, r);
		...
		graphics2D.drawRect(0, 0, Main.width - 2, Main.height - 2);
